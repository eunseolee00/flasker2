...
class PaymentForm(FlaskForm):
	id = IntegerField("Payment ID#", validators=[DataRequired()])
...
def add_payment():
	...
	if form.validate_on_submit():
		try:
			...
			if payment is None:
				payment = Payment(id = form.id.data, credit_card=form.credit_card.data, name_on_card=form.name_on_card.data,
...
def update_payment(id):
	...
	if request.method == "POST":
		payment_to_update.id = request.form['id']
